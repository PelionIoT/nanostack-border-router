...
static conf_t yotta_config[] = {
    ...
    {"RF_CHANNEL_PAGE", NULL, YOTTA_CFG_BORDER_ROUTER_RF_CHANNEL_PAGE},
    {"RF_CHANNEL_MASK", NULL, YOTTA_CFG_BORDER_ROUTER_RF_CHANNEL_MASK},
    ...
    {"PREFIX_FROM_BACKHAUL", NULL, YOTTA_CFG_BORDER_ROUTER_PREFIX_FROM_BACKHAUL},
