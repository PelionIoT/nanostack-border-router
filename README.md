...
Applications using Nanostack Border Router need to use a `.json` file for the configuration. The example configurations can be found in [K64f-border-router] https://github.com/ARMmbed/k64f-border-router-private/configs. Where you can also find all the descriptions for the parameters.
